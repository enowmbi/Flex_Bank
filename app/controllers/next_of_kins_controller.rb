class NextOfKinsController < ApplicationController
  ...
  private
    ...
    def next_of_kin_params
      params.require(:next_of_kin).permit(:first_name, :middle_name, :last_name, :address, :phone, :email, :relationship, :identification_type_id, :identification_number, :bank_account_id)
    end
end
