...
class AccountTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    ...
    assert_select "h1","Account Types"
  end

  test "should get new" do
    get new_account_type_url
    assert_response :success
    assert_select "h1","New Account Type"
  end

  test "should create account_type" do
    assert_difference('AccountType.count') do
      post account_types_url, params: { account_type: { description: @account_type.description, name: @account_type.name, normal_balance: @account_type.normal_balance } }
    end
  ...
  test "should show account_type" do
    ...
    assert_response :success
    assert_select "h1",@account_type.name + " Details"
  end

  test "should get edit" do
    get edit_account_type_url(@account_type)
    assert_response :success
    assert_select "h1","Editing Account Type(#{@account_type.name})"
  end

  test "should update account_type" do
    patch account_type_url(@account_type), params: { account_type: { description: @account_type.description, name: @account_type.name, normal_balance: @account_type.normal_balance } }
