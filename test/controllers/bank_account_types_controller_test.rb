...
class BankAccountTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account_type" do
    assert_difference('BankAccountType.count') do
      post bank_account_types_url, params: { bank_account_type: { description: @bank_account_type.description, name: @bank_account_type.name } }
    end
  ...
  test "should update bank_account_type" do
    patch bank_account_type_url(@bank_account_type), params: { bank_account_type: { description: @bank_account_type.description, name: @bank_account_type.name } }
